...
catalog_csv='../SeisData/seis_1990_2021_M4.csv'
PNG_OUTPUT_DIRECTORY="M4_1990_2021"

crs = {'init': 'epsg:4326'}

QGIS_path='/home/chunghung/.conda/envs/QGIS'
QGIS_plugin=f'{QGIS_path}/plugins'
#QGIS_plugin='/home/chunghung/.conda/envs/QGIS/share/qgis/python/plugins'
...
def zoom_qgis_cut(zoom,QGIS_path,QGIS_plugin):
    ## add the tilelayer 
...
for zoom in range(6,8):
    print(zoom)
    zoom_qgis_cut(zoom,QGIS_path,QGIS_plugin)
qgs.exitQgis()  
